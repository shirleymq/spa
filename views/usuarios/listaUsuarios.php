          ...
          <tbody>
            ...
            foreach ($usuarios as $usuario):
              ...
              <tr>
                ...
                <td>
                  <?php echo $usuario['NOMBREU'] . ' ' . $usuario['APELLIDOU'] ?>
                </td>
                <td>
                  <?php echo $usuario['USERNAME'] ?>
                </td>
                <td>
                  <?php echo $usuario['CODTIPO'] ?>
                </td>
                <td>
                  <?php echo $usuario['HABILITADO'] ?>
                </td>
                <?php
                if (isset($_SESSION['login_nombre'])) { ?>
                  ...
                  <?php if ($usuario['HABILITADO'] == 'SI') { ?>
                    <td>
                      <a href="../../controllers/controladorUsuarios.php?idUsuario=<?php echo $usuario['IDUSUARIO'] ?>&deshabilitar=true"
                        class="btn btn-outline-danger">Deshabilitar</a>
                    </td>
                  <?php } else { ?>
                    <td>
                      <a href="../../controllers/controladorUsuarios.php?idUsuario=<?php echo $usuario['IDUSUARIO'] ?>&habilitar=true"
