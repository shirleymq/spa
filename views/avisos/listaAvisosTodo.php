...
<html>
    ...
    <body>
          ...
          <nav class="navbar navbar-expand-lg navbar-dark bg-dark position-sticky">
            ...
            <div class="collapse navbar-collapse position-sticky" id="navbarNavAltMarkup">
              <div class="navbar-nav" >
                ...
                <a class="nav-item nav-link active" href="listaAvisos.php" data-toggle="modal" data-target="#modalLogin">
                    <button class="btn btn-sm btn-outline-secondary" style="color:white;" >
                      Avisos Habilitados
                    </button>
                  <span class="sr-only">(current)</span>
        ...
        <section class="contenido wrapper">
          <h1 align="center">Lista Avisos Deshabilitados</h1>
          <center>
            <div class="col-md-10">
          <table id="customers" border="1" class="table">
            ...
            <tbody>
                ...
                <?php
               $avisosDes = listaAvisosDes(); 
                foreach ($avisosDes as $aviso):
              ?>
              <tr>
                ...
                <?php
                  if (isset($_SESSION['login_nombre'])){?>
                  <td>
                    <a href="editar.php?codAviso=<?php echo $aviso['CODAVISO'] ?>" class="btn btn-outline-warning">Editar</a>
                    <p></p>
