              ...
              <tr>
                ...
                if (isset($_SESSION['login_nombre'])) {
                  ...
                  <?php if ($imagen['HABILITADO'] == 'SI') { ?>
                    <td>
                      <a href="../../controllers/controladorPublicidades.php?id_aviso=<?php echo $imagen['id_imagen'] ?>&deshabilitar=true"
                        class="btn btn-outline-danger">Deshabilitar</a>
                    </td>
                  <?php } else { ?>
                    <td>
                      <a href="../../controllers/controladorPublicidades.php?id_aviso=<?php echo $imagen['id_imagen'] ?>&habilitar=true"
