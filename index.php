...
<body onload="mueveReloj()" style="overflow-x: hidden;">
	...
	<header class="azul">
		<div class="navbar  navbar-expand-lg azul" style="height: 10vh">
			...
			<div class="col-md-9" align="center">
				<h2 align="center" style="color: white ; font-family: Georgia; font-weight: bold;">DEPARTAMENTO DE
					INFORMATICA Y SISTEMAS</h2>
			</div>
			...
			<div class=" col-md-2 offset-md-0" align="center">
				...
				<form name="form_reloj">
					...
					<input type="text" name="reloj" size="7" class="display-4 text-center"
						onfocus="window.document.form_reloj.reloj.blur()"
						style="background-color:   #09073b  ; color: white; border:#1a045a; font-family: Roboto-Bold;">
				...
				<nav>
					...
					<ul style="list-style: none, background: white;">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" style="font-size: 2em" href="#" id="navbarDropdown"
								role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							</a>
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="">
								<?php
								if (!isset($_SESSION['login_nombre'])) { ?>
									<li><a class="dropdown-item " data-toggle="modal" data-target="#modalLogin"
											style="color: #6145a5; font-family: Roboto-Light"><b>Sesion</b></a></li>
									<div class="dropdown-divider"></div>
								<?php } ?>
								<li><a class="dropdown-item " href="views/avisos/listaAvisos.php"
										style="color:  #6145a5; font-family: Roboto-Light"><b>Avisos<b></a></li>
								<li><a class="dropdown-item " href="views/publicidades/listaPublicidades.php"
										style="color: #6145a5; font-family: Roboto-Light"><b>Anuncios</b></a></li>
								<?php
								if (isset($_SESSION['login_nombre'])) {
									if (($_SESSION['login_tipo_usuario']) == "ADMIN") {
										?>
										<div class="dropdown-divider"></div>
										<li><a class="dropdown-item " href="views/registros/listaBitacora.php"
												style="color: #6145a5; font-family: Roboto-Light"><b>Bitacora</b></a></li>
										<li><a class="dropdown-item " href="views/usuarios/listaUsuarios.php"
												style="color: #6145a5; font-family: Roboto-Light"><b>Usuarios</b></a></li>
									<?php } ?>
									<div class="dropdown-divider"></div>
									<li><a class="dropdown-item " href="controllers/logout.php"
											style="color: #6145a5; font-family: Roboto-Light"><b>Cerrar sesion</b></a></li>
					...
					<div class="modal-content fondoSesion">
						<div class="moddal-header">
							<button type="button" class="close" data-dismiss="modal"
								style="padding-right: 1.5rem;padding-top: 1rem;">&times;</button>
						</div>
						<div class="modal-body">
							...
							<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
								<form class="login100-form validate-form" action="controllers/autentificar.php"
									method="POST">

									<div class="wrap-input100 validate-input m-b-16">
										<input class="input100" type="text" name="cuenta"
	...
	<section>
		...
		<div class="row">
								...
								<div class="contenedor">
									<div class="centralizador">
										...
										<table class="table monitor">
											<tr align="right">
												<td colspan="2" style="font-family: Lucida;">
													<?php echo $aviso['FECHA_HORA'] ?>
												</td>
											</tr>
											<tr align="center">
												<td colspan="2">
													<h2 class="display-4 titulo-aviso"><b>
											...
											if (!empty($aviso['NOMBREDOC']) && !empty($aviso['NOMBREMAT'])) {
												...
												<tr align="center">
													<td width="50%"
														style="font-family: Georgia; color: #110c9c font-weight: bold; " ,
														align="center">
														<h4><b>
																<?php echo $aviso['NOMBREDOC'] . ' ' . $aviso['APELLIDODOC'] ?>
															</b></h4>
													</td>
													<td style="font-family: Georgia; color: #09073b; font-weight: bold;"
														align="center">
														<h4><b>
																<?php echo $aviso['NOMBREMAT'] ?>
															</b></h4>
													</td>
												</tr>
												<?php
											...
											?>
											<tr align="center">
												<td colspan="2" style="font-family: MonotypeCorsiva;">
													<h3 class="display-4">
											...
											if (!empty($aviso['SUBTITULO'])) {
												...
												<tr>
													<td colspan="2" class="una-linea"
														...
														<span
															style="display: inline-block; text-transform: uppercase; font-family: Georgia; color: #640717; font-size: xx-large;">
			...
			<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 sin_padding"
				style="height: 85vh; background:  url('uploads/fondoF2.jpg');">
				<br>
		...
		<div class="row">
			<div class="col-md-3 sin_padding" align="center" style="background:  #640717 ; height: 100%  ;">
				...
				<script type="text/javascript"
					src="https://www.tutiempo.net/s-widget/l_yvBgrxtxY2EcfjpANAVzzDDDztaATff2bd1t1cioa1D"></script>
